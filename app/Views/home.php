            ...
            <div class="container">
                <div class="row align-center">
					...
					<div class="col-lg-8 col-md-7">
						<div class="banner-caption dark">
							<div class="col-md-12 col-sm-12 banner-text left">
								<h1 class="small">Find your dream jobs with us easily</h1>
								<div class="full-search-2 eclip-search italian-search hero-search-radius">
									<div class="hero-search-content">

										<div class="row">

											<div class="col-lg-5 col-md-5 col-sm-12 small-padd b-r">
					...
					<div class="col-lg-4 col-md-5">
						<div class="jobs_video">
							<div class="thumb">
								<img class="pro_img img-fluid w100" src="assets/img/gtrr.jpg" alt="7.jpg">
                ...
                <div class="row extra-mrg">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="job-instructor-layout">
							...
							<div class="job-instructor-thumb">
								<a href="job-detail.html"><img src="assets/img/com-2.jpg" class="img-fluid" alt="" /></a>
							</div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="job-instructor-layout">
							...
							<div class="job-instructor-thumb">
								<a href="job-detail.html"><img src="assets/img/com-3.jpg" class="img-fluid" alt="" /></a>
							</div>
							<div class="job-instructor-content">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="job-instructor-layout">
							...
							<div class="job-instructor-thumb">
								<a href="job-detail.html"><img src="assets/img/com-4.jpg" class="img-fluid" alt="" /></a>
							</div>
							<div class="job-instructor-content">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="job-instructor-layout">
							...
							<div class="brows-job-type"><span class="freelanc">Freelancer</span></div>
							<div class="job-instructor-thumb">
								<a href="job-detail.html"><img src="assets/img/com-5.jpg" class="img-fluid" alt="" /></a>
							</div>
							<div class="job-instructor-content">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="job-instructor-layout">
							<div class="brows-job-type"><span class="part-time">Part Time</span></div>
							<div class="job-instructor-thumb">
								<a href="job-detail.html"><img src="assets/img/com-6.jpg" class="img-fluid" alt="" /></a>
							</div>
							<div class="job-instructor-content">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="job-instructor-layout">
							...
							<div class="brows-job-type"><span class="full-time">Full Time</span></div>
							<div class="job-instructor-thumb">
								<a href="job-detail.html"><img src="assets/img/com-7.jpg" class="img-fluid" alt="" /></a>
							</div>
							<div class="job-instructor-content">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="job-instructor-layout">
							...
							<div class="brows-job-type"><span class="full-time">Full Time</span></div>
							<div class="job-instructor-thumb">
								<a href="job-detail.html"><img src="assets/img/com-1.jpg" class="img-fluid" alt="" /></a>
							</div>
							<div class="job-instructor-content">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-4">
                        <div class="working-process"><span class="process-img"><img src="assets/img/step-1.png" class="img-responsive" alt=""/><span class="process-num">01</span></span>
                            <h4>Create An Account</h4>
                            <p>Post a job to tell us about your project. We'll quickly match you with the right freelancers find place best.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="working-process"><span class="process-img"><img src="assets/img/step-2.png" class="img-responsive" alt=""/><span class="process-num">02</span></span>
                            <h4>Search Jobs</h4>
                            <p>Post a job to tell us about your project. We'll quickly match you with the right freelancers find place best.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="working-process"><span class="process-img"><img src="assets/img/step-3.png" class="img-responsive" alt=""/><span class="process-num">03</span></span>
                            <h4>Save & Apply</h4>
                            <p>Post a job to tell us about your project. We'll quickly match you with the right freelancers find place best.</p>
                        </div>
                    </div>
...
<!-- Mirrored from codeminifier.com/job-stock-5.4.1/job-stock/index-7.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Nov 2020 07:36:44 GMT -->
</html>
